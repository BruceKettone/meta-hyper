...
qemu-system-aarch64 \
  ...
  -serial stdio \
  -append "root=/dev/vda rw console=ttyAMA0 iommu.passthrough=1 nomodeset vfio_iommu_type1.allow_unsafe_interrupts=1 sysctl.vm.min_free_kbytes=16384 memmap=32M\$0x50000000"
